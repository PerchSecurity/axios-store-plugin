...
var axiosStore = function axiosStore(axiosInstance) {
  var reqOrCache = function reqOrCache() {
    ...
    return cachedData ? Promise.resolve(Object.assign(cachedData, { cacheKey: cacheKey, fromCache: true })) : axiosInstance.get.apply(axiosInstance, arg).then(function (_ref) {
      var data = _ref.data;
